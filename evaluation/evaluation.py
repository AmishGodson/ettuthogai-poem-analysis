...
class Evaluator:
    ...
    def evaluate(self, y_true, y_pred):
        ...
        print("\n==============================")
        print("ENTITY DISTRIBUTION (GROUND TRUTH)")
        print("==============================\n")
        ...
        df_true.plot(kind="bar", legend=False, title="Entity Distribution (True)")
        ...
        df_pred.plot(kind="bar", legend=False, title="Entity Distribution (Predicted)")
        plt.ylabel("Frequency")
        plt.show()
...
if __name__ == "__main__":
    ...
    # Example entity labels (replace with your real NER outputs)
